...
public class Inflector {
    ...
    public static void main(String[] args) {
        System.out.println(Inflector.getInstance().pluralize("wool"));
        System.out.println(Inflector.getInstance().singularize("wool"));

        System.out.println(Inflector.getInstance().pluralize("news"));
        System.out.println(Inflector.getInstance().singularize("news"));

        System.out.println(Inflector.getInstance().pluralize("woman"));
        System.out.println(Inflector.getInstance().singularize("woman"));

        System.out.println(Inflector.getInstance().pluralize("women"));
        System.out.println(Inflector.getInstance().singularize("women"));

        System.out.println(HasDigit("fdjskl"));
        System.out.println(HasDigit("fdjs3kl"));

        System.out.println(HasDigit("4fdjskl"));
        System.out.println(HasDigit("fdjs3kl5"));
        System.out.println(HasDigit("7895"));
    }
